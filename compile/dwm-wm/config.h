...
/* commands */
static const char *dmenu_cmd[] = { "~/scripts/path_dmenu", NULL };
static const char *term_cmd[]  = { "urxvtc", "-e", "zsh", "-c", "tmux", NULL };
static const char *sleep_cmd[]  = { "sudo /usr/sbin/pm-suspend", NULL };
static const char *email_cmd[]  = { "~/scripts/email/check_mailbox.sh", "~/accounts.dat", NULL };
static const char *alsa_cmd[]  = { "urxvtc", "-e", "amixer", NULL };
static const char *ranger_cmd[]  = { "urxvtc", "-e", "ranger", NULL };
static const char *touchpad_toggle_cmd[] = { "~/scripts/touchpad_toggle", NULL };
//static const char *print_screen_cmd[] = { "scrot", "'%Y-%m-%d-%H%M%S_$wx$h.png'", "-e", "'mv $f ~/images/screenshots'", NULL };
//static const char *print_screen_area_cmd[] = { "sleep 0.2;", "scrot", "'%Y-%m-%d-%H%M%S_$wx$h.png'", "-e", "'mv $f ~/images/screenshots'", "-s", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_F12,    spawn,          {.v = touchpad_toggle_cmd } },
